<template>
    <div class="articleDetail">
        <!--      返回到最顶层-->
        <el-backtop style="z-index: 1000000" :visibility-height="10" target="#sss"/>
        ...
        <div class="blogTitle" style="justify-content: center;z-index: 1000;margin-top: -350px">
        ...
        <div class="articleDetailContent">
            ...
            <div style="padding: 20px">
                <markdown-it-vue class="md-body" :content="blog.content"
                                 :options="{markdownIt: {html: true,langPrefix: true}}"/>
            </div>


            <div class="wechat_icon">
                <el-image src="http://pic.zhoutao123.com/wecaht/wechat_icon_3.png" id="wechatIconImg"></el-image>
            </div>
...
<style scoped>
    .articleDetail {
        ...
        border-radius: 10px;
        font-family: "Hack Nerd Font", "Arial", "Microsoft YaHei", "黑体", "宋体", sans-serif;
    }
